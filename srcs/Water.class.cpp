...
/*   Updated: 2015/03/23 20:33:40 by mmartin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Water::Waves(bool n, bool s, bool e, bool w)
{
	...
	//	Check lowest hight
	float	zmin = WavesMin(n, s, e, w, wave);
...
//	Wave functions
float Water::WavesMin(bool n, bool s, bool e, bool w, float wave)
{
	float	zmin = 1.0;
